import { ArrowTopRightOnSquareIcon, ArrowUpIcon, BellIcon, ChartBarIcon, CreditCardIcon, DocumentMagnifyingGlassIcon, EnvelopeIcon, HomeIcon } from "@heroicons/react/24/solid"
const Sidebar = () => {
  return (
